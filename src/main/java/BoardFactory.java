...
public class BoardFactory {
    // Static method to load a default board image and create a Board object
    public static Board loadDefault(Path boardImgPath) {
        try {
            ...
            // Create an Img object by reading the file at the provided path
            Img bg = new BuffImg().read(boardImgPath.toString());

            // Create and return a Board object with 8x8 cells and each cell 'cell' pixels wide/high
