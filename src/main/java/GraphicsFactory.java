...
public class GraphicsFactory {
    ...
    /**
     * Loads a Graphics animation object from a directory of sprite images,
     ...
     * @return A new Graphics object initialized with the sprites and configuration.
     */
    public Graphics load(Path spritesDir, JSONObject cfg, Dimension cellSize) {
        ...
        // Create and return a Graphics instance with given parameters.
