...
public class KeyboardProducer extends Thread {
    ...
    // keyBoard.KeyboardProcessor to interpret key inputs and manage cursor/actions
    ...
    /**
     * Provides access to the associated keyBoard.KeyboardProcessor, useful for tests or external usage.
     *
     * @return The keyBoard.KeyboardProcessor linked to this producer
     */
